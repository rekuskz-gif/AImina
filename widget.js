...
(function() {
    ...
    const mobileStyles = `
        ...
        /* ╔══════════════════════════════════════════════════════════╗ */
        /* ║ КНОПКА MOBILE: 115×115 → 150×150 (+30%)                 ║ */
        /* ║ Расчёт: 115 × 1.3 = 149.5 ≈ 150px                       ║ */
        /* ╚══════════════════════════════════════════════════════════╝ */
        /* Шарик увеличен на 30% для лучшей видимости на мобилке */
        .amina-btn { 
            width: 150px;              /* 115 + 30% = 150px */
            height: 150px;             /* 115 + 30% = 150px */
        }
        
        /* АВАТАР внутри кнопки: 97×97 → 126×126 (+30%) → 107×107 (-15%) */
        /* Расчёт: 126 × 0.85 = 107.1 ≈ 107px */
        .amina-btn img { 
            width: 107px;              /* 126 - 15% = 107px */
            height: 107px;             /* 126 - 15% = 107px */
        }
        
        /* КРАСНЫЙ ЗНАЧОК: 37×37 → 48×48 (+30%) */
        /* Расчёт: 37 × 1.3 = 48.1 ≈ 48px */
        .amina-badge { 
            width: 48px;               /* 37 + 30% = 48px */
            height: 48px;              /* 37 + 30% = 48px */
            font-size: 18px;           /* 16 + 12% ≈ 18px */
        }
